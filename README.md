Esta aplicação é destinada a ajustes no valor total do inventário, pelo registro 74 do arquivo de texto do Sintegra gerado em softwares ERP. Para praticidade e agilidade no processo de ajuste de valores, 
